<div class="robo-advisors-filters">
    <form action="{{ route('roboAdvisors') }}" method="post" role="form" autocomplete="off">
        ...
        <div class="robo-advisors-filter js-ra-filter">
            <div class="robo-advisors-filter__header js-ra-filter-header">
                <div class="robo-advisors-filter__title">
                    General
                </div>
                <div class="robo-advisors-filter__arrow">
                    @svg('arrow-up', 'robo-advisors-filter__arrow-up')
                </div>
            </div>
            <div class="robo-advisors-filter__body js-ra-filter-body">
