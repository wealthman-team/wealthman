                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control js-select2" id="robo-advisor-account-types-input" name="account_types[]" multiple style="width: 100%;">
                                                    @foreach($accountTypes as $accountType)
                                                        <option value="{{ $accountType->id }}" {{ in_array($accountType->id, (old('account_types') ?? [])) ? 'selected' : '' }}>{{ $accountType->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tab-robo-advisor-rating">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-ui-slider js-no-ui-slider"
                                                 ...
                                                 data-max="10"
                                            ></div>
                                            <div class="no-ui-slider-value" id="robo-advisor-commissions-value">{{ old('commissions') }}</div>
                                            <input class="form-control" id="robo-advisor-commissions-input" type="hidden" name="commissions" value="{{ old('commissions') }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-ui-slider js-no-ui-slider"
                                                 ...
                                                 data-max="10"
                                            ></div>
                                            <div class="no-ui-slider-value" id="robo-advisor-service-value">{{ old('service') }}</div>
                                            <input class="form-control" id="robo-advisor-service-input" type="hidden" name="service" value="{{ old('service') }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-ui-slider js-no-ui-slider"
                                                 ...
                                                 data-max="10"
                                            ></div>
                                            <div class="no-ui-slider-value" id="robo-advisor-comfortable-value">{{ old('comfortable') }}</div>
                                            <input class="form-control" id="robo-advisor-comfortable-input" type="hidden" name="comfortable" value="{{ old('comfortable') }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-ui-slider js-no-ui-slider"
                                                 ...
                                                 data-max="10"
                                            ></div>
                                            <div class="no-ui-slider-value" id="robo-advisor-tools-value">{{ old('tools') }}</div>
                                            <input class="form-control" id="robo-advisor-tools-input" type="hidden" name="tools" value="{{ old('tools') }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-ui-slider js-no-ui-slider"
                                                 ...
                                                 data-max="10"
                                            ></div>
                                            <div class="no-ui-slider-value" id="robo-advisor-investment-options-value">{{ old('investment_options') }}</div>
                                            <input class="form-control" id="robo-advisor-investment-options-input" type="hidden" name="investment_options" value="{{ old('investment_options') }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="no-ui-slider js-no-ui-slider"
                                                 ...
                                                 data-max="10"
                                            ></div>
                                            <div class="no-ui-slider-value" id="robo-advisor-asset-allocation-value">{{ old('asset_allocation') }}</div>
                                            <input class="form-control" id="robo-advisor-asset-allocation-input" type="hidden" name="asset_allocation" value="{{ old('asset_allocation') }}">
                                        </div>
                                    </div>
